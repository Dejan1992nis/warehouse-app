...
function getFilteredInventoryItems() {
    ...
    if (inventoryFilters.stock.length) {

        filtered = filtered.filter(item => {

            return inventoryFilters.stock.includes(
                getStockStatus(item)
            );
    ...
    if (inventoryFilters.itemStatus.length) {

        filtered = filtered.filter(item => {

            return inventoryFilters.itemStatus.includes(
                item.status
            );
    ...
    if (inventoryFilters.warehouse.length) {
        ...
        filtered = filtered.filter(item => {
            ...
            return inventoryFilters.warehouse.includes(
                warehouse
            );
    ...
    switch (inventoryFilters.sort) {
        ...
        case 'priority':
            ...
            filtered.sort((a, b) => {
                ...
                return (
                    priority[getStockStatus(a)] -
                    priority[getStockStatus(b)]
                );
...
case 'ok':
    ...
    break;
            ...
            card.innerHTML = `
                ...
                <span class="inventory-location">${item.location || '-'}</span>
